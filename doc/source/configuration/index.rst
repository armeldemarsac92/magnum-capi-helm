...
magnum.conf plesese refer to `config-reference.rst`
...
testedvcan be found `here <https://github.com/azimuth-cloud/capi-helm-charts/blob/main/.github/workflows/ensure-capi-images.yaml#L9>`__.
...
* helm_extra_values: Allows operators to map arbitrary cluster
  ...
  examples are presenting usage of this funcionality
...
As a result, after spawning cluster, we will have zabix agent deployed with ip
