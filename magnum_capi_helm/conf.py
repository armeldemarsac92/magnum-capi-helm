...
capi_helm_cluster_labels_opts = [
    ...
    cfg.IntOpt(
        "etcd_volume_size",
        default=0,
        deprecated_opts=[cfg.DeprecatedOpt("etcd_volume_size", group="capi_helm")],
        help="Deprecated: use etcd_blockdevice_size instead.",
    ),
    cfg.StrOpt(
        "etcd_volume_type",
        default="",
        deprecated_opts=[cfg.DeprecatedOpt("etcd_volume_type", group="capi_helm")],
    ...
    cfg.StrOpt(
        ...
        default="nova",
        deprecated_opts=[
            cfg.DeprecatedOpt("csi_cinder_availability_zone", group="capi_helm")
        ],
    ...
    cfg.StrOpt(
        ...
        deprecated_opts=[
            cfg.DeprecatedOpt("csi_cinder_volume_binding_mode", group="capi_helm")
        ],
        help=(
    ...
    cfg.BoolOpt(
        ...
        default=True,
        deprecated_opts=[
            cfg.DeprecatedOpt("csi_cinder_allow_volume_expansion", group="capi_helm")
        ],
...
CONF.register_opts(capi_helm_cluster_labels_opts, group=capi_helm_cluster_labels_group)
...
def list_capi_cluster_label_opts():
    return [(capi_helm_cluster_labels_group, [o]) for o in capi_helm_cluster_labels_opts]
