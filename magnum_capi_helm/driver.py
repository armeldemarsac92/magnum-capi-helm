...
class Driver(driver.Driver):
    ...
    def rotate_credential(self, context, cluster):
        LOG.info(f"Rotating application credential for cluster {cluster.uuid}")
        ...
        try:
            ...
            cluster.save()
            raise exception.MagnumException(message=msg)
        ...
        if not new_app_cred:
            ...
            # TODO(northcottmt): Apply ownership of the cluster to the new app
            # cred owner
