...
class Driver(driver.Driver):
    ...
    def _get_node_counts(self, cluster, nodegroup):
        ...
        # the autoscaler) so if a user creates a nodegroup where only node_count
        # is provided and min/max are not, we need to be careful about setting
        # the default min/max values to equal node_count.
