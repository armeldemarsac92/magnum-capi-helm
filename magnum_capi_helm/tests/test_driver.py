...
class ClusterAPIDriverTest(base.DbTestCase):
    ...
    @mock.patch.object(driver.Driver, "_create_appcred_secret")
    @mock.patch.object(driver.Driver, "_get_app_cred_id")
    def test_rotate_credential(self, mock_get, mock_create, mock_delete):
    ...
    @mock.patch.object(driver.Driver, "_create_appcred_secret")
    @mock.patch.object(driver.Driver, "_get_app_cred_id")
    def test_rotate_credential_delete_failed(self, mock_get, mock_create):
    ...
    @mock.patch.object(driver.Driver, "_create_appcred_secret")
    @mock.patch.object(driver.Driver, "_get_app_cred_id")
    def test_rotate_credential_create_failed(self, mock_get, mock_create):
    ...
    @mock.patch.object(driver.Driver, "_create_appcred_secret")
    @mock.patch.object(driver.Driver, "_get_app_cred_id")
    def test_rotate_credential_is_none(self, mock_get, mock_create):
    ...
    @mock.patch.object(driver.Driver, "_create_appcred_secret")
    @mock.patch.object(driver.Driver, "_get_app_cred_id")
    def test_rotate_credential_unchanged(self, mock_get, mock_create):
