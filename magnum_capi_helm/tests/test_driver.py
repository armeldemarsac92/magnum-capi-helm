...
class ClusterAPIDriverTest(base.DbTestCase):
    ...
    def test_create_cluster_octavia_provider_ovn(
        ...
        for provider in ["ovn", "OVN"]:

            # Simulate setting provider label
            self.cluster_obj.labels = {
                "octavia_provider": provider,
                # Test that this is ignored since only allowed method
                # for OVN LBs is SOURCE_IP_PORT
                "octavia_lb_algorithm": "not-used",
            }
