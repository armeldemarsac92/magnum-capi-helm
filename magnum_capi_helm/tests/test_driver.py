...
class ClusterAPIDriverTest(base.DbTestCase):
    ...
    def test_nodegroup_master_lb_fip(
        ...
        # Disabled master LB in labels should override floating_ip_enabled.
        ...
        # Enabled master LB in labels should override floating_ip_enabled
        ...
        # Absent master lb labels should default to floating_ip_enabled
        self.cluster_obj.labels = {}
        self.cluster_obj.cluster_template.floating_ip_enabled = False
        mock_image.return_value = (
            "imageid1",
